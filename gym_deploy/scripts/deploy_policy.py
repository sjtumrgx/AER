...
from gym_deploy.utils.deployment_runner import DeploymentRunner
from gym_deploy.envs.lcm_agent import LCMAgent
from gym_deploy.utils.cheetah_state_estimator import StateEstimator
from gym_deploy.utils.command_profile import *
...
def load_and_run_policy(label, experiment_name, max_vel=1.0, max_yaw_vel=1.0):
    ...
    from gym_deploy.envs.history_wrapper import HistoryWrapper
