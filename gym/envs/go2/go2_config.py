"""Unitree Go2 simulation configuration.

This file is intentionally self-contained so Go2 is the only runtime robot
family exposed by the public training and play scripts.
"""
