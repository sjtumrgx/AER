...
class AdaptiveGo2ConfigTerrain(Go2Config):
    ...
    class rewards(Go2Config.rewards):
        ...
        class scales(Go2Config.rewards.scales):
    ...
    class terrain(Go2Config.terrain):
    ...
    class domain_rand(Go2Config.domain_rand):
